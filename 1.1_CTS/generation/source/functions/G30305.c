...
CT_Result G30305_PathStroking_by_ATI (CT_File *AnsFile)
{
    VGPaint fillpaint;
    VGPaint strokepaint;
 ...
 VGPath path247;
 VGubyte  path247cmd[]={ /* 2 segments */
   VG_MOVE_TO_ABS    , VG_LCWARC_TO_ABS  };
 VGfloat path247coord[]={ /* 7 coordinates */
    -2.000000e+001f,  -1.000000e+001f,   2.000000e+001f,   1.000000e+001f,   1.100000e+001f,  -2.000000e+001f,
     1.000000e+001f};
    ...
    path247=vgCreatePath(VG_PATH_FORMAT_STANDARD,VG_PATH_DATATYPE_F, 1.0000f,0.0000f, 0,0, (unsigned int)VG_PATH_CAPABILITY_APPEND_TO);
    vgAppendPathData(path247,sizeof(path247cmd)/sizeof(VGubyte),path247cmd,path247coord);

    if ( path247 == VG_INVALID_HANDLE )
       return CT_ERROR;
  ...
  vgDrawPath(path247,VG_FILL_PATH|VG_STROKE_PATH);

    vgDestroyPath(path247);
