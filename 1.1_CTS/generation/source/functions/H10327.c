...
CT_Result H10327_ImageOperation_by_HYBRID(CT_File *AnsFile)
{
    VGImage src;
    VGImage dst;   
    ...
    dst = vgCreateImage(VG_sRGBA_8888_PRE, gradient_width, gradient_height*13, VG_IMAGE_QUALITY_NONANTIALIASED|VG_IMAGE_QUALITY_BETTER);
