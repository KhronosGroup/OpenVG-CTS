...
CT_Result H10330_ImageOperation_by_HYBRID(CT_File *AnsFile)
{
    VGImage pukki_src;
    ...
    vgCopyImage(pukki_src, 0, 16, pukki_src, 16, 16, 64, 64, VG_FALSE);
    vgCopyImage(pukki_src, 16, 16, pukki_src, 26, 26, 32, 32, VG_FALSE);
    vgDrawImage(pukki_src);
	vgClear(0, 32, 64, 32);
	vgClear(32, 0, 32, 32);
    ...
    vgCopyImage(pukki_src, 0, 0, pukki_src, 30, 25, 64, 64, VG_FALSE);
    vgTranslate(0, 32);
    vgDrawImage(pukki_src);
	vgClear(32, 0, 32, 64);

	/* Copy the whole image */
    vgCopyImage(pukki_src, 0, 0, pukki_src, 0, 0, 64, 64, VG_FALSE);
    vgLoadIdentity();
    vgTranslate(32, 0);
    vgDrawImage(pukki_src);
	vgClear(32, 32, 32, 32);
    ...
    vgCopyImage(pukki_src, 0, 0, pukki_src, 16, 16, 8, 35, VG_FALSE);
    vgCopyImage(pukki_src, 0, 16, pukki_src, 16, 32, 40, 16, VG_FALSE);
    vgCopyImage(pukki_src, 16, 16, pukki_src, 32, 32, 26, 26, VG_FALSE);
    vgCopyImage(pukki_src, 18, 0, pukki_src, 34, 16, 26, 26, VG_FALSE);
    vgCopyImage(pukki_src, 5, 18, pukki_src, 21, 34, 5, 5, VG_FALSE);
    vgLoadIdentity();
    vgTranslate(32, 32);
    vgDrawImage(pukki_src);
