...
CT_Result G30210_PathStroking_by_ATI (CT_File *AnsFile)
{
    VGPath path;
    VGPaint fillpaint;
    VGPaint strokepaint;

    VGubyte  path3cmd[]={ /* 2 segments */
        VG_MOVE_TO_ABS    , VG_CUBIC_TO_ABS };
    VGfloat path3coord[]={ /* 8 coordinates */
        -1.000000e-001f,   7.000000e+000f,   0.000000e+000f,   7.000000e+000f,   0.000000e+000f,  -7.000000e+000f,
            1.000000e-001f,  -7.000000e+000f};
    VGubyte  path4cmd[]={ /* 2 segments */
        VG_MOVE_TO_ABS    , VG_CUBIC_TO_ABS };
    VGfloat path4coord[]={ /* 8 coordinates */
        21.90000e+000f,   7.000000e+000f,  22.000000e+000f,   7.000000e+000f,   26.000000e+000f,  -7.000000e+000f,
        26.100000e+000f,  -7.000000e+000f};


    VGfloat matrix[] = {
        1.300000e+000f, 0.000000e+000f, 0.000000e+000f,
        0.000000e+000f, 1.300000e+000f, 0.000000e+000f,
        1.600000e+001f, 3.000000e+001f, 1.000000e+000f};
    ...
    vgAppendPathData(path,sizeof(path3cmd)/sizeof(VGubyte),path3cmd,path3coord);
    vgAppendPathData(path,sizeof(path4cmd)/sizeof(VGubyte),path4cmd,path4coord);
