...
CT_Result G21001_PathOperation_by_HUONE (CT_File *AnsFile, VGuint subtest)               
{
    VGPath line, point;
    ...
    vgPathTransformedBounds(line, &minX, &minY, &width, &height);
    ...
    vgPathTransformedBounds(point, &minX, &minY, &width, &height);
    if (subtest == 1)
    {
        values[0] = minX;
        values[1] = minY;
