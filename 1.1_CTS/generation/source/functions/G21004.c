...
CT_Result G21004_PathOperation_by_HUONE (CT_File *AnsFile)               
{
    VGPath  arc;
    
    VGubyte arcCommands[4] = {VG_MOVE_TO_ABS, VG_SCCWARC_TO_ABS, VG_LCCWARC_TO_ABS, VG_CLOSE_PATH};
    ...
    vgPathTransformedBounds(arc, &minX, &minY, &width, &height);
