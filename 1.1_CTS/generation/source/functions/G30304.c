...
CT_Result G30304_PathStroking_by_ATI (CT_File *AnsFile)
{
    VGPaint fillpaint;
    VGPaint strokepaint;
 ...
 VGPath path246;
 VGubyte  path246cmd[]={ /* 2 segments */
   VG_MOVE_TO_ABS    , VG_LCWARC_TO_ABS  };
 VGfloat path246coord[]={ /* 7 coordinates */
    -2.000000e+001f,  -1.000000e+001f,   2.000000e+001f,   2.000000e+001f,   1.100000e+001f,  -2.000000e+001f,
     1.000000e+001f};
    ...
    path246=vgCreatePath(VG_PATH_FORMAT_STANDARD,VG_PATH_DATATYPE_F, 1.0000f,0.0000f, 0,0, (unsigned int)VG_PATH_CAPABILITY_APPEND_TO);
    vgAppendPathData(path246,sizeof(path246cmd)/sizeof(VGubyte),path246cmd,path246coord);

    if ( path246 == VG_INVALID_HANDLE )
        return CT_ERROR;
  ...
  vgDrawPath(path246,VG_FILL_PATH|VG_STROKE_PATH);

    vgDestroyPath(path246);
