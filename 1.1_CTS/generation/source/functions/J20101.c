...
CT_Result J20101_FilterConvolve_by_HYBRID(CT_File *AnsFile, VGuint subtest)
{
    VGImage srcImg;
    VGImage dstImg;
    VGfloat bgCol[4];
    ...
    switch ( subtest )
    {
        case 0:
            vgConvolve(dstImg, srcImg, 3, 3, 0, 0, identKernel,
                       1.0f, 0.0f, VG_TILE_FILL);
            break;
        case 1:
	        /* Test that results of Y shifting are as expected. */
            vgConvolve(dstImg, srcImg, 3, 3, 0, 3, identKernel,
                       1.0f, 0.0f, VG_TILE_FILL);
            break;
        case 2:
	        /* Test that results of Y shifting are as expected. */
        ...
        case 3:
            ...
            vgConvolve(dstImg, srcImg, 3, 3, 3, 0, identKernel,
                       1.0f, 0.0f, VG_TILE_FILL);
            break;
        case 4:
	        /* Test that results of X shifting are as expected. */
        ...
        case 5:
	        /* Combined shift */
            vgConvolve(dstImg, srcImg, 3, 3, 3, 3, identKernel,
                       1.0f, 0.0f, VG_TILE_FILL);
            break;
    }
