...
CT_Result J20203_FilterConvolve_by_HYBRID(CT_File *AnsFile, VGuint subtest)
{
    VGImage srcImg;
    VGImage dstImg;
    ...
    VGshort identKernelX[3]	= {0, 0, 1};
    VGshort identKernelY[3]	= {0, 0, 1};
    ...
    switch ( subtest )
    {
        ...
        case 0:
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 0, 0,
                identKernelX, identKernelY, 0.5f, 0, VG_TILE_FILL);
            break;
        /* Convolve with scale 2  */
        case 1:
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 0, 0, 
                identKernelX, identKernelY, 2, 0, VG_TILE_FILL);
            break;
        /*  Convolve with bias -0.25f */
        case 2:
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 0, 0,
                identKernelX, identKernelY, 1, -0.25f, VG_TILE_FILL);
            break;
        /*  Convolve with bias 0.25f */
        case 3:
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 0, 0, 
        ...
        case 4:
            ...
            vgCopyImage(dstImg, 0, 0, srcImg, 0, 0, 32, 32, VG_FALSE);
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 0, 0, 
                identKernelX, identKernelY, 0.5f, 0, VG_TILE_FILL);
            break;
        ...
        case 6:
            ...
            vgCopyImage(dstImg, 0, 0, srcImg, 0, 0, 32, 32, VG_FALSE);
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 0, 0, 
                identKernelX, identKernelY, 1, -0.5f, VG_TILE_FILL);
            break;
        /*  Alpha channel only convolve with bias 0.5f */
        case 7:
            vgSeti(VG_FILTER_CHANNEL_MASK, 1);
        ...
        case 8:
            ...
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 0, 0, 
                identKernelX, identKernelY, -1003, 0, VG_TILE_FILL);
            break;
        /*  Test under- and overflows */
        case 9:
            vgSeti(VG_FILTER_CHANNEL_MASK, 14);
        ...
        case 10:
            ...
            vgSeti(VG_FILTER_FORMAT_PREMULTIPLIED, VG_TRUE);
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 0, 0, 
                identKernelX, identKernelY, 1, -1003, VG_TILE_FILL);
            break;
        /*  Test under- and overflows */
        case 11:
            vgSeti(VG_FILTER_CHANNEL_MASK, 14);
