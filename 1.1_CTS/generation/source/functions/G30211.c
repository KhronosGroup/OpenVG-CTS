...
CT_Result G30211_PathStroking_by_ATI (CT_File *AnsFile)
{
    VGPath path;
    VGPaint fillpaint;
    VGPaint strokepaint;

    VGubyte  path11cmd[]={ /* 2 segments */
        VG_MOVE_TO_ABS    , VG_CUBIC_TO_ABS   };
    VGfloat path11coord[]={ /* 8 coordinates */
        1.000000e+000f,   1.000000e+000f,   0.000000e+000f,   2.000000e+000f,   0.000000e+000f,  -2.000000e+000f,
        1.000000e+000f,  -1.000000e+000f};

    VGubyte  path12cmd[]={ /* 2 segments */
        VG_MOVE_TO_ABS    , VG_CUBIC_TO_ABS   };
    VGfloat path12coord[]={ /* 8 coordinates */
        1.000000e+000f,   1.000000e+000f,   0.000000e+000f,   2.000000e+000f,   0.000000e+000f,  -2.000000e+000f,
        1.000000e+000f,  -1.000000e+000f};


    VGfloat matrix[] = {
        2.500000e+000f, 0.000000e+000f, 0.000000e+000f,
        0.000000e+000f, 2.500000e+000f, 0.000000e+000f,
        3.100000e+001f, 3.200000e+001f, 1.000000e+000f};
    ...
    vgAppendPathData(path,sizeof(path11cmd)/sizeof(VGubyte),path11cmd,path11coord);
    ...
    vgAppendPathData(path,sizeof(path12cmd)/sizeof(VGubyte),path12cmd,path12coord);
