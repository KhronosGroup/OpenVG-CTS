...
#include "../main.h"
#include "../util/util.h"
#include "../static/hybrid/color_fans_64x64.h"

#ifdef WIN32
#pragma optimize ("", off)
#endif

CT_Result J20303_FilterConvolve_by_HYBRID(CT_File *AnsFile)
{
    VGImage combo_image;
    VGImage blurred;
    VGfloat col[4];
    ...
    vgImageSubData(combo_image, color_fans_64x64_data, 256, VG_sRGBA_8888, 0, 0, 64, 64);

	/* Target image */
    blurred = vgCreateImage(VG_sRGBA_8888, 64, 64, VG_IMAGE_QUALITY_BETTER);

    vgGaussianBlur(blurred, combo_image, 16.0f, 16.0f, VG_TILE_REFLECT);
