...
CT_Result H10328_ImageOperation_by_HYBRID(CT_File *AnsFile)
{
    VGImage src;
    VGImage dst;   
    ...
    dst = vgCreateImage(VG_sRGBX_8888, gradient_width, gradient_height*13, VG_IMAGE_QUALITY_NONANTIALIASED|VG_IMAGE_QUALITY_BETTER);
