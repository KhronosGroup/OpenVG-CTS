...
CT_Result G20610_PathOperation_by_HUONE (CT_File *AnsFile)               
{
    VGPath  startPath, endPath, dstPath;
    VGPaint strokePaint;
    VGubyte startCommands[12] = {VG_MOVE_TO_ABS, VG_LINE_TO_ABS, VG_CLOSE_PATH, 
                                VG_MOVE_TO_ABS, VG_QUAD_TO_ABS, VG_CLOSE_PATH,
                                VG_MOVE_TO_ABS, VG_CUBIC_TO_ABS, VG_CLOSE_PATH,
                                VG_MOVE_TO_ABS, VG_LCWARC_TO_ABS, VG_CLOSE_PATH};
    VGubyte endCommands[12]   = {VG_MOVE_TO_ABS, VG_LINE_TO_ABS, VG_CLOSE_PATH, 
                                VG_MOVE_TO_ABS, VG_QUAD_TO_ABS, VG_CLOSE_PATH,
                                VG_MOVE_TO_ABS, VG_CUBIC_TO_ABS, VG_CLOSE_PATH,
                                VG_MOVE_TO_ABS, VG_LCWARC_TO_ABS, VG_CLOSE_PATH};
    VGfloat startCoords[]     = {34.0f,16.0f, 48.0f,16.0f, 
                                48.0f, 16.0f, 48.0f,32.0f, 48.0f,32.0f, 
                                48.0f, 32.0f, 48.0f,48.0f, 48.0f,48.0f, 48.0f,48.0f,
                                48.0f, 48.0f, 0.0f, 0.0f, 0.0f, 34.0f, 48.0f};
    VGfloat endCoords[]       = {30.0f,16.0f, 16.0f,16.0f, 
                                16.0f, 16.0f, 16.0f,32.0f, 16.0f,32.0f, 
                                16.0f, 32.0f, 16.0f,48.0f, 16.0f,48.0f, 16.0f,48.0f,
                                16.0f, 48.0f, 0.0f, 0.0f, 0.0f, 30.0f, 48.0f};
    ...
    /* startPath=line, quad, cubic, arc */
    /* endPath=line, quad, cubic, arc   */
    /* amount=0.5f                      */
    vgAppendPathData(startPath, 12, startCommands, startCoords);
    vgAppendPathData(endPath, 12, endCommands, endCoords);
    vgAppendPath(dstPath, startPath);
