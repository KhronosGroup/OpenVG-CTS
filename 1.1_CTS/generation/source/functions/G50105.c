...
CT_Result G50105_PathFilling_by_HYBRID(CT_File *AnsFile)
{
    VGPath  path;
    VGPaint stroke;
    VGPaint fill;
    VGfloat bgCol[4]        = {0.f, 0.f, 0.f, 1.f};
    VGfloat xformStore[9]   = {0.f, 0.f, 0.f, 
                               0.f, 0.f, 0.f, 
                               0.f, 0.f, 0.f};
    VGfloat color1[4]       = {1.f, 0.f, 0.f, 1.0f};
    VGfloat color2[4]       = {0.f, 1.f, 0.f, 1.0f};
    VGint   i;
