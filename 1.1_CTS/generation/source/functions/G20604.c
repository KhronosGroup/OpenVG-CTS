...
CT_Result G20604_PathOperation_by_HUONE (CT_File *AnsFile)               
{
    ...
    VGubyte endCommands[5]   = {VG_MOVE_TO_ABS, VG_LINE_TO_ABS, VG_LINE_TO_ABS, VG_LINE_TO_ABS, VG_LINE_TO_ABS};
    ...
    VGfloat endCoords[]      = {40.0f,0.0f, 56.0f,16.0f, 48.0f,32.0f, 56.0f,48.0f, 40.0f,64.0f};
