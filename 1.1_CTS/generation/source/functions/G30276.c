...
CT_Result G30276_PathStroking_by_HYBRID(CT_File *AnsFile)
{
    VGPaint stroke;
    VGPath	path1;
    ...
    VGfloat coords1[8]	= {0.111f, 0.125f,	0.f, 0.f, 0.375f, 0.3f, 0.75f, 0.f};
	VGfloat coords2[6]	= {0.375f, 0.3f, 0.75f, 0, 0.75f, 0};
    VGint	i;
	...
	/* Lower line: Start point and the first control point conincide. */
	...
	/* Upper line: End point and the second control point coinciding */
