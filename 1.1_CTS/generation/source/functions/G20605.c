...
CT_Result G20605_PathOperation_by_HUONE (CT_File *AnsFile)               
{
    VGPath  startPath, endPath, dstPath;
    VGPaint strokePaint;
    VGubyte startCommands[5] = {VG_MOVE_TO_ABS, VG_QUAD_TO_ABS, VG_SQUAD_TO_ABS, VG_CUBIC_TO_ABS, VG_SCUBIC_TO_ABS};
    VGubyte endCommands[5]   = {VG_MOVE_TO_ABS, VG_QUAD_TO_ABS, VG_SQUAD_TO_ABS, VG_CUBIC_TO_ABS, VG_SCUBIC_TO_ABS};
    VGfloat startCoords[]    = {24.0f,0.0f, 8.0f,0.0f, 8.0f,16.0f, 16.0f,32.0f, 24.0f,32.0f, 24.0f,48.0f, 16.0f,48.0f, 8.0f,64.0f, 24.0f,64.0f};
    VGfloat endCoords[]      = {40.0f,0.0f, 56.0f,0.0f, 56.0f,16.0f, 48.0f,32.0f, 40.0f,32.0f, 40.0f,48.0f, 48.0f,48.0f, 56.0f,64.0f, 40.0f,64.0f};
    ...
    /* endPath=curve   */
    /* amount=0.5f     */
    vgAppendPathData(startPath, 5, startCommands, startCoords);
    vgAppendPathData(endPath, 5, endCommands, endCoords);
