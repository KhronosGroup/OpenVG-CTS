...
CT_Result J20202_FilterConvolve_by_HYBRID(CT_File *AnsFile, VGuint subtest)
{
    VGImage srcImg;
    VGImage dstImg;
    VGfloat bgCol[4];
    ...
    VGfloat black[4];
    VGfloat white[4];
    VGshort transKernelX[7] = { 0, 0, 0, 0, 0, 0, 0 };
    VGshort transKernelY[7] = { 0, 0, 0, 0, 0, 0, 0 };
    ...
    switch ( subtest )
    {
        case 0:
	        transKernelX[0] = 1;
	        transKernelY[0] = 1;
            vgSeparableConvolve(dstImg, srcImg, 7, 7, 3, 3,
                transKernelX, transKernelY, 1, 0, VG_TILE_FILL);
            break;
        case 1:
	        transKernelX[0] = 1;
	        transKernelY[6] = 1;
