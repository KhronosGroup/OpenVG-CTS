...
CT_Result G30278_PathStroking_by_HYBRID(CT_File *AnsFile)
{
    VGPaint stroke;
    VGPath	path1;
    ...
    VGfloat coords1[8]	= {0.111f, 0.125f,	-0.3f, 0.f, 0.9f, 0.f, 0.75f, 0.f};
	VGfloat coords2[6]	= {0, 0, 0, 0, 0.75f, 0};
    VGint	i;
	...
	/* Lower line: All points on the same line, controls outside the end/startpoints. */
	...
	/* Upper line: All control points at the start point  */
