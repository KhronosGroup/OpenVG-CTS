...
CT_Result J20204_FilterConvolve_by_HYBRID(CT_File *AnsFile, VGuint subtest)
{
    VGImage srcImg;
    VGImage dstImg;
    VGfloat bgCol[4];
    ...
    switch ( subtest )
    {
        /* FILL */
        case 0:
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 16, 16, 
                identKernelX, identKernelY, 1, 0, VG_TILE_FILL);
            break;
        /* PAD */
        case 1:
            vgSeparableConvolve(dstImg, srcImg, 3, 3, -16, 16, 
                identKernelX, identKernelY, 1, 0, VG_TILE_PAD);
            break;
        /* REPEAT */
        case 2:
            vgSeparableConvolve(dstImg, srcImg, 3, 3, 16, -16, 
                identKernelX, identKernelY, 1, 0, VG_TILE_REPEAT);
            break;
        /* REFLECT */
        case 3:
            vgSeparableConvolve(dstImg, srcImg, 3, 3, -16, -16, 
                identKernelX, identKernelY, 1, 0, VG_TILE_REFLECT);
            break;
    }
