...
CT_Result M20202_VguHLPrim_by_HUONE (CT_File *AnsFile)               
{
    ...
    VGfloat coords[]     = {32.0f, 64.0f, 64.0f, 0.0f, 0.0f, 32.0f, 64.0f, 32.0f, 0.0f, 0.0f};
    ...
    path  = vgCreatePath( VG_PATH_FORMAT_STANDARD, VG_PATH_DATATYPE_S_8, 1.0f, 0.0f, 0, 0, VG_PATH_CAPABILITY_ALL );
    if ( path == VG_INVALID_HANDLE ) {
		vgDestroyPaint(paint);
        return CT_ERROR;
    }
    
    vguPolygon(path, coords, 5, VG_TRUE); /* include VG_CLOSE_PATH */
