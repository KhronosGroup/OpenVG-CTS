...
CT_Result G10102_PathSegment_by_HUONE (CT_File *AnsFile)               
{
    /* Absent VG_MOVE_TO */
    VGPath path;
    VGPaint paint;
    VGubyte commands[4] = {VG_LINE_TO_ABS, VG_LINE_TO_ABS, VG_LINE_TO_ABS, VG_CLOSE_PATH};
    VGfloat clearColor[] = {1.0f, 1.0f, 1.0f, 1.0f};/* white color */                                              
    VGfloat fillColor[] = {1.0f, 0.0f, 0.0f, 1.0f};/* red color */
    VGfloat coords[] = {32.0f,  0.0f, 32.0f, 32.0f,  0.0f, 32.0f};
