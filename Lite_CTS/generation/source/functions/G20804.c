...
CT_Result G20804_PathOperation_by_HUONE (CT_File *AnsFile)               
{
    VGPath  arc;
    ...
    vgPointAlongPath(arc, 0, 1, -1, &x, &y, &tangentX, &tangentY);
    values[0] = x;
    values[1] = y;
    values[2] = tangentX;
    values[3] = tangentY;   

    vgPointAlongPath(arc, 1, 1, epsilon, &x, &y, &tangentX, &tangentY);
    ...
    vgPointAlongPath(arc, 2, 1, epsilon, &x, &y, &tangentX, &tangentY);
