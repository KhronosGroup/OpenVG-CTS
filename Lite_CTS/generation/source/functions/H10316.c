...
CT_Result H10316_ImageOperation_by_HYBRID(CT_File *AnsFile, VGuint subtest)
{
    VGImage src;
    VGImage dst;   
    ...
    /* Create the destination image */
    {
        ...
        { VG_A_8, VG_A_1, VG_A_4 };
        dst = vgCreateImage(formats[subtest], gradient_width, gradient_height*13, VG_IMAGE_QUALITY_NONANTIALIASED|VG_IMAGE_QUALITY_BETTER);
    }
    ...
    if (vgGetError() == VG_NO_ERROR) {
        SAVE_SUBTEST_IMAGE(subtest, dst);
