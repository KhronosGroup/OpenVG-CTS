...
CT_Result G30277_PathStroking_by_HYBRID(CT_File *AnsFile)
{
    VGPaint stroke;
    VGPath	path1;
    ...
    VGfloat coords1[8]	= {0.111f, 0.125f,	0.375f, 0.3f, 0.375f, 0.3f, 0.75f, 0.f};
	VGfloat coords2[6]	= {0.f, 0.f, 0.75f, 0.f, 0.75f, 0.f};
    VGint	i;
	...
	/* Lower line: Control points coinciding in the middle. */
	...
	/* Upper line: Control points coincide with respective end points. */
