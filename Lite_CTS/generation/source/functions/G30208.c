...
CT_Result G30208_PathStroking_by_ATI (CT_File *AnsFile)
{
    VGPath path;
    VGPaint fillpaint;
    VGPaint strokepaint;

    VGubyte  path1cmd[]={  /* 2 segments */
    VG_MOVE_TO_ABS    , VG_CUBIC_TO_ABS   };
    VGfloat path1coord[]={ /* 8 coordinates */
     0.000000e+000f,   4.000000e+001f,   2.000000e+001f,   0.000000e+000f,   0.000000e+000f,   0.000000e+000f,
     2.000000e+001f,   4.000000e+001f};
    ...
    vgAppendPathData(path,sizeof(path1cmd)/sizeof(VGubyte),path1cmd,path1coord);
