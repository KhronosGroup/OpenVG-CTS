...
CT_Result I30103_PaintGradient_by_HUONE (CT_File *AnsFile)               
{
    VGPath path;
    VGPaint paint;
    ...
    VGfloat rampStop[10] = {0.0f, 1.1f, 0.0f, -0.3f, 1.0f, 
    ...
    vgSetParameterfv( paint, VG_PAINT_COLOR_RAMP_STOPS, 10, rampStop );
