...
CT_Result G30213_PathStroking_by_ATI (CT_File *AnsFile)
{
    VGPath path;
    VGPaint fillpaint;
    VGPaint strokepaint;

    VGubyte  path15cmd[]={ /* 2 segments */
        VG_MOVE_TO_ABS    , VG_CUBIC_TO_ABS   };
    VGfloat path15coord[]={ /* 8 coordinates */
         0.000000e+000f,   0.000000e+000f,   0.000000e+000f,  -1.000000e+001f,   0.000000e+000f,   1.000000e+001f,
         0.000000e+000f,   0.000000e+000f};

    VGubyte  path16cmd[]={ /* 2 segments */
        VG_MOVE_TO_ABS    , VG_CUBIC_TO_ABS   };
    VGfloat path16coord[]={ /* 8 coordinates */
         0.000000e+000f,   0.000000e+000f,   0.000000e+000f,   0.000000e+000f,   0.000000e+000f,   0.000000e+000f,
         0.000000e+000f,   0.000000e+000f};

    VGubyte  path17cmd[]={ /* 2 segments */
        VG_MOVE_TO_ABS    , VG_CUBIC_TO_ABS   };
    VGfloat path17coord[]={ /* 8 coordinates */
         8.000000e+000f,   2.000000e+001f,   8.000000e+000f,   2.000000e+001f,   8.000000e+000f,   2.000000e+001f,
         8.000000e+000f,   2.000000e+001f};

    VGfloat matrix[] = {
        1.300000e+000f, 0.000000e+000f, 0.000000e+000f,
        0.000000e+000f, 1.300000e+000f, 0.000000e+000f,
        1.700000e+001f, 2.000000e+001f, 1.000000e+000f};
    ...
    vgAppendPathData(path,sizeof(path15cmd)/sizeof(VGubyte),path15cmd,path15coord);
    ...
    vgAppendPathData(path,sizeof(path16cmd)/sizeof(VGubyte),path16cmd,path16coord);
    ...
    vgSetColor(strokepaint,0x0000FFFF);
    vgSetPaint(strokepaint, VG_STROKE_PATH);
    vgSetf(VG_STROKE_LINE_WIDTH,15.0000f);
    vgSetf(VG_STROKE_MITER_LIMIT,4.0000f);
    ...
    vgClearPath(path,VG_PATH_CAPABILITY_ALL);
    vgAppendPathData(path,sizeof(path17cmd)/sizeof(VGubyte),path17cmd,path17coord);
